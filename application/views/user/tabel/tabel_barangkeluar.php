<br><br><br>
    ...
    <h2 class="tex-center">Tabel Barang Inventaris Keluar</h2>
    ...
    <a href="<?=base_url('user/tabel_barangmasuk')?>" style="margin-bottom:10px;float:right;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data Keluar</a>
