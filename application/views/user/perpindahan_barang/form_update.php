      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/user_proses_data_keluar')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input autocomplete="off" type="text" name="tanggal_keluar" style="margin-left:66px;width:20%;display:inline;" class="form-control form_datetime" required="" placeholder="Klik Disini">
                </div>
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="lokasi" style="margin-left:220px;display:inline;">Nama Sekolah</label>
