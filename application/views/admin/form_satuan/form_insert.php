...
<head>
  ...
  <title>Inventaris | Satuan Barang</title>
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="nama_satuan" style="width:90%;margin-right: 67px;" class="form-control" id="nama_satuan" placeholder="Kategori">
              </div>
              <div class="form-group" style="display:inline-block;">
