...
<head>
  ...
  <title>Inventaris | Edit Satuan</title>
                ...
                <div class="form-group">
                  <?php foreach($data_satuan as $d){ ?>
                    <div class="box-body">
                      ...
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_satuan" style="width:73%;">Kategori</label>
                        <input type="text" required name="nama_satuan" style="width:90%;margin-right: 67px;" class="form-control" id="nama_satuan" placeholder="Kategori" value="<?=$d->nama_satuan?>">
                    </div>
                    <div class="form-group" style="display:inline-block;">
